...
.. code-block:: javascript

    {
        "data": {
            "amount": 10,  // 面值
            "code": "BZVTADUYBIL",  // 红包code
            "expired_at": 1531238400,  // 过期日期
            "get_at": 1530633600,  // 获取日期
            "is_used": null,  // 是否使用
            "min_amount": 100,  // 最小限制金额
            "user_id": 2  // 所属用户
        },
        "status": {
            "code": 201,
...
.. code-block:: javascript
    ...
    {
        "data": {
            "bonus_rid": "BZVTADUYBIL",  // 红包code
            "bonus_amount": 10,  // 红包优惠金额
