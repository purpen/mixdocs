...
核心平台--店铺授权商品列表
-----------------------------
核心平台下通过店铺编号获取指定店铺下的商品

接口说明
~~~~~~~~~~~~~~

* API接口请求地址：``/core_platforms/products/by_store``
* API接口请求方法：``GET``
...
sort_type               Number      可选         1         排序: 1=综合排序, 2=价格由低至高, 3=价格由高至低
...
核心平台--店铺授权商品数量
-----------------------------
核心平台下通过店铺编号获取指定店铺下的商品数量

接口说明
~~~~~~~~~~~~~~

* API接口请求地址：``/core_platforms/products/by_store/count``
* API接口请求方法：``GET``
...
page            Number    可选         1         当前页码
per_page        Number    可选         10        每页数量
sort_type       Number    可选         0         排序: 0=默认排序, 1=最新, 2=价格由低至高, 3=价格由高至低
cids            String    可选                   分类编号， 多个用, 隔开
min_price       Number    可选                   价格区间： 最小价格
max_price       Number    可选                   价格区间： 最大价格
status          Number    可选         1         商品状态： 0： 全部 , 1: 上架中, 2: 下架中, 3: 仓库中, 4: 已售罄
==============  ========  =========  ========  ====================================
...
.. code-block:: javascript

    {
        "data": {
            ...
            "products": [
                {
                    "cover": "https://s3.lexivip.com/lxServer/lexi-b/1508671414566.jpg",  //封面图
                    "is_free_postage": true,    //是否包邮
                    "like_count": 2,            //商品喜欢数
                    "min_price": 2345.6,        //最低零售价
                    "min_sale_price": 2256,     //最低折扣价
                    "name": "情人節字母擴香石組合",   //商品名
                    "rid": "8527906841",        //商品编号
                    "status": 1                 //商品状态： 0=仓库中 1=出售中 2=已下架 3=已删除
                }
            ]
        },
        "status": {
...
名称             类型      是否必须    默认值     描述说明
==============  ========  =========  ========  ====================================
type            Number    可选         1        商品类型: 0=全部商品, 1=自营商品, 2=分销商品
==============  ========  =========  ========  ====================================
...
* API接口请求地址：``/products/custom_made``
* API接口请求方法：``GET``
...
* API接口请求地址：``/products/free_postage``
* API接口请求方法：``GET``
...
sort_newest             Number      可选         0         按最新排序: 0=否, 1=是
=====================  ==========  =========  ==========  =============================
...
* API接口请求地址：``/products/free_postage/count``
* API接口请求方法：``GET``
