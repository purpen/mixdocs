...
* API接口请求地址：``/store/practice_countdown``
* API接口请求方法：``GET``
* API接口用户授权：``token``
...
名称          类型      是否必须    默认值     描述说明
===========  ========  =========  ========  =====================================================================================================
phases        Number     必须                馆主阶段, 1: 实习馆主; 2: 正式馆主
===========  ========  =========  ========  =====================================================================================================
...
.. code-block:: javascript
    ...
    {
        "data": {
            "logo": "http://0.0.0.0:9000/_uploads/photos/static/img/default2-logo-180x180.png",  // 店铺logo
            "name": "",  // 店铺名称
            "rid": "97958360",  // 店铺编号
            "tag_line": "sdjkf"  //  宣传语
        },
